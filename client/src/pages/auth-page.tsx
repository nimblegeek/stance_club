    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-background">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gray-900 items-center justify-center p-8">
        <div className="max-w-md text-center">
          <h1 className="text-4xl font-bold text-white mb-4">Project Management Simplified</h1>
          <p className="text-gray-400 text-lg">
            Organize your projects, collaborate with your team, and stay on top of your tasks with ProjectHub.
          </p>
