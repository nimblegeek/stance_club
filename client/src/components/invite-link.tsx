  ...
  const copyToClipboard = async () => {
    try {
      ...
      toast({
        title: "Copy failed",
        description:
          "Could not copy to clipboard. Please try manually selecting the link.",
        variant: "destructive",
      });
    }
  };
    ...
    <Dialog open={showDialog} onOpenChange={setShowDialog}>
      ...
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Share this link with potential members to let them sign up directly
            for your club.
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="message" className="mt-4">
            <div className="bg-muted p-4 rounded-md">
              ...
              <p className="mb-2">
                I'd like to invite you to join our Brazilian Jiu-Jitsu club. We
                have classes for all skill levels and a great community of
                practitioners.
              </p>
              <p className="mb-2">
                You can sign up using this link: {signupLink}
              </p>
